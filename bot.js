...
const botSay = (data) => {
  return [
    "hey I am Thuan Bhacot. siapa nama kamu?",
...
function finishing() {
  pertanyaan.innerHTML = `Thank u ya ${usersData[0]} udah main ke forum kegabutan gw ini 😉, kali-kali kita main ${usersData[2]} bareng ya!`
